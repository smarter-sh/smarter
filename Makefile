...
docker-test:
	make docker-check && \
	docker exec smarter-app bash -c "python manage.py test smarter.apps.plugin.manifest.brokers.tests.test_static_plugin_broker.TestSmarterStaticPluginBroker.test_apply"
