...
docker-test:
	make docker-check && \
	docker exec smarter-app bash -c "./manage.py test smarter.apps.api.v1.cli.tests.test_base_class.TestApiCliV1BaseClass.test_authentication_with_no_apikey_private"
