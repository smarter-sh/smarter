...
docker-test:
	make docker-check && \
	docker exec smarter-app bash -c "./manage.py test smarter.apps.plugin.management.tests.test_managepy_commands.ManageCommandCreatePluginTestCase.test_retrieve_plugin"
