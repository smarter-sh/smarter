...
in llmclients and the Workbench.
...
Smarter manages every resource — providers, llmclients, plugins — the same way:
...
.. tip::
   ...
   With both providers registered, you can create two llmclients — one backed
