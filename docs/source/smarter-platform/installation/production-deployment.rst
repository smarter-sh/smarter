...
`PromptWorkbenchView.dispatch() <https://github.com/smarter-sh/smarter/blob/main/smarter/smarter/apps/prompt/views/detailview/chatapp_workbench_view.py#L160>`__. See below.
