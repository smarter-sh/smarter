...
Smarter Resources are a combination of :doc:`LLM Provider APIs <smarter-resources/smarter-provider>`, :doc:`SQL database data <smarter-framework/lib/django>`,
...
Smarter Resources are declared using :doc:`Smarter Application Manifests (SAM) <smarter-framework/lib/manifests>`, which are `YAML <https://en.wikipedia.org/wiki/YAML>`__ files
