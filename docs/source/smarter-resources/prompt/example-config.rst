...
- **llmclient** : Exactly one :doc:`llmclient <../smarter-llmclient>` is associated with a chat session. This serialization
  is generated by :py:class:`smarter.apps.llmclient.serializers.LLMClientConfigSerializer`.
...
- **meta_data**: generated by :py:class:`smarter.apps.llmclient.models.LLMClientHelper`.
- **plugins**: a compound object containing the following keys:

  - :py:class:`smarter.apps.llmclient.serializers.LLMClientPluginSerializer`.
  - :py:class:`smarter.apps.llmclient.models.LLMClientPlugin`.
