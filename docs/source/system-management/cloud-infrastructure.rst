...
`Terraform <https://developer.hashicorp.com/terraform>`_ scripts to fully automate the deployment and management of all AWS infrastructure
resources required for normal operation of the Smarter platform.

**Official Smarter Terraform Scripts** - `https://github.com/smarter-sh/smarter-infrastructure <https://github.com/smarter-sh/smarter-infrastructure>`_.
