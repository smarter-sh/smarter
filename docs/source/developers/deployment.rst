...
To deploy Smarter locally for development or testing purposes, you can use this `docker-compose.yml <https://github.com/smarter-sh/smarter/blob/main/docker-compose.yml>`
...
The Smarter project maintains a Helm chart located in the `./helm/charts/smarter <https://github.com/smarter-sh/smarter/tree/main/helm/charts/smarter>`
directory of the smarter repository. This chart is published to `https://artifacthub.io/packages/helm/project-smarter/smarter <https://artifacthub.io/packages/helm/project-smarter/smarter>`
and is regularly updated with each new release. You can use this Helm chart to deploy Smarter to any Kubernetes cluster.

You should also familiarize yourself with the Smarter Terraform modules located in `https://github.com/smarter-sh/smarter-infrastructure <https://github.com/smarter-sh/smarter-infrastructure>`
