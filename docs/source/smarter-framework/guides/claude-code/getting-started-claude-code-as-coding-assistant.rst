...
Concept Overview
----------------
Smarter as the orchestration layer and Anthropic Claude as the computation engine. Smarter sends standardized requests, then routes results into llmclients, Workbench sessions, and downstream pipelines.
