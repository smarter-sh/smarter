...
This project conforms to `12-factor methodology <https://12factor.net/>`__.
...
2. **Dependencies**: [✅] Explicitly declare and isolate dependencies.
   We’re using Terraform’s built-in package lock, Python’s requirements files,
   and NPM’s package.json to declare dependencies.
