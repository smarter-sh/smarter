...
At the core of this approach is a sophisticated runtime asset pipeline built around Vite’s
...
The React build manifest is a JSON file generated by Vite that provides a single
...
The manifest.json file is generated by Vite.js <https://vite.dev/>_,
...
.. code-block:: jinja
  ...
  {% block javascript_extra %}
    ...
    {% terminal_emulator_vite_assets "index.html" as assets %}
    <script class="smarter" type="module" src="{% static 'react/terminal_emulator/' %}{{ assets.js }}"></script>
  {% endblock %}
