...
.. image:: https://img.shields.io/github/stars/smarter-sh/smarter?style=social
   :target: https://github.com/smarter-sh/smarter
   :alt: GitHub stars
...
.. image:: https://readthedocs.org/projects/smarter/badge/?version=latest
   :target: https://docs.smarter.sh
...
You'll be up and running in about 10 minutes!

1. Install Docker Desktop. If you haven't already, download and install Docker Desktop. This will also install Docker Compose.

2. Prepare Your Environment File. Smarter requires a .env file with your credentials and configuration. You can scaffold a template using the following command:
...
3. Initialize the Application. This step pulls the Docker containers, and seeds the platform with test data:
...
4. Start the Application. Run the following command to start all Docker containers and launch the web server:
...
5. Log In. Go to http://localhost:8000/login/ and log in with:
