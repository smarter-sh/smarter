...
- [smarter.apps.dashboard.templatetags.vite_prompt_passthrough.prompt_passthrough_react_assets](../../smarter/apps/dashboard/templatetags/vite_prompt_passthrough.py)
