...
/**
 * Loads plugin data from the backend API and updates state.
 *
 * @param setterCallback - State setter for updating the plugin list.
 * @param setLoading - State setter for loading state.
 * @param urlSlug - The API slug for the plugin group (e.g., "owned" or "shared").
