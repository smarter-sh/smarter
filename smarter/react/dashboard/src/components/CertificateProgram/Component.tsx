...
function CertificateProgram({ apiUrl }: CertificateProgramProps) {
  ...
  return (
    <>
      <section className="certificate-program" aria-label="Certificate Program">
          {/* begin::Col */}
              ...
              <div className="card-body py-6">
                ...
                <div className="carousel-inner">
                  ...
                  <div className="carousel-item active show">
                    ...
                    {/* begin::Action */}
                    <div className="m-0">
                      <a href="https://smarter.sh/" className="btn btn-sm btn-light me-2 mb-2">Details</a>
                      <a href="https://smarter.sh/" className="btn btn-sm btn-success mb-2">Apply</a>
                    </div>
                    {/* end::Action */}
                  </div>
