        ...
        <div className="position-relative fs-2x z-index-2 fw-bold text-white mb-0">
          ...
          <span className="me-2"
            ...
            <span className="position-relative d-inline-block text-danger mb-2">
              ...
              {/* begin::Separator */}
              <span
                className="position-absolute opacity-50 bottom-0 start-0 border-4 border-danger border-bottom w-100 p-3"
              ></span>
              {/* end::Separator */}
            </span>
          </span>
          {/* end::Title */}
          <p className="text-gray-200 fs-6 fw-normal mt-3 mb-10" style={{ maxWidth: "80%" }}>The Smarter Manifest VS Code Extension provides intelligent syntax checking,
          context-sensitive microhelp, and real-time code suggestions.
          </p>
          {/* end::Title */}
          {/* begin::Action */}
