    ...
    <>
      ...
      <div className="col-xl-4 mb-xl-10">
        ...
        <div className="card card-flush h-xl-100">
          {/* begin::Heading */}
          <div className="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style={{ backgroundImage: "url('/static/assets/media/svg/shapes/top-green.png')" }} data-bs-theme="light">
          <img
                ...
                {my_resources_pending_deployments > 0 && (
                  <>
                    ...
                    <span className="position-relative d-inline-block">
                      <a href="/prompts/" className="link-white opacity-75-hover fw-bold d-block mb-1">{my_resources_pending_deployments} pending</a>
                      {/* begin::Separator */}
                      <span className="position-absolute opacity-50 bottom-0 start-0 border-2 border-body border-bottom w-100"></span>
                      {/* end::Separator */}
                    </span>
                    <span className="opacity-75">{my_resources_pending_deployments > 1 ? "deployments" : "deployment"}</span>
                  </>
                )}
              </div>
            </h3>
              ...
              <div className="row g-3 g-lg-6">
                ...
                <div className="col-6">
                  ...
                  <a href="/prompts/">
                    <div className="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                      ...
                      <div className="m-0">
                        {/* begin::Number */}
                        <span className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{my_resources_chatbots }</span>
                        {/* end::Number */}
                        {/* begin::Desc */}
                        <span className="text-gray-500 fw-semibold fs-6">Agents</span>
                        {/* end::Desc */}
                      </div>
                      {/* end::Workbench */}
                    </div>
                ...
                <div className="col-6">
                  ...
                  <div className="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                    ...
                    <a href="/plugins/">
                      <div className="m-0">
                        {/* begin::Number */}
                        <span className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{ my_resources_plugins }</span>
                        {/* end::Number */}
                        {/* begin::Desc */}
                        <span className="text-gray-500 fw-semibold fs-6">Plugins</span>
                        {/* end::Desc */}
                      </div>
                    </a>
                    {/* end::Plugins */}
                ...
                <div className="col-6">
                  ...
                  <div className="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                    ...
                    {/* end::Symbol */}
                    {/* begin::Connections */}
                    <a className="menu-link" href="/connections/" target="_self">
                      <div className="m-0">
                        {/* begin::Number */}
                        <span className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{ my_resources_connections }</span>
                        {/* end::Number */}
                        {/* begin::Desc */}
                ...
                <div className="col-6">
                  ...
                  <div className="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                    ...
                    {/* end::Symbol */}
                    {/* begin::Secrets */}
                    <a className="menu-link" href="/providers/" target="_self">
                      <div className="m-0">
                        {/* begin::Number */}
                        <span className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{ my_resources_providers }</span>
                        {/* end::Number */}
                        {/* begin::Desc */}
                        <span className="text-gray-500 fw-semibold fs-6">Providers</span>
                        {/* end::Desc */}
                      </div>
                    </a>
                    {/* end::Secrets */}
