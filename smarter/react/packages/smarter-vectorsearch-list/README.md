...
This is the source code for the Vectorsearch List app located
at [http://localhost:9357/vectorsearch/](http://localhost:9357/vectorsearch/).

This component is served by Django. See also:

- [smarter.apps.vectorsearch.views.listview.view.VectorsearchListView](../../smarter/apps/vectorsearch/views/listview/view.py)
- [smarter.apps.vectorsearch.templatetags.react_vectorsearch_list.vectorsearch_list_react_assets](../../smarter/apps/vectorsearch/templatetags/react_vectorsearch_list.py)
- [templates/react/vectorsearch-list.html](../../smarter/templates/react/vectorsearch-list.html)

## Screen Shot

![Vectorsearch List Screenshot](https://cdn.smarter.sh/github.com/smarter-sh/react/vectorsearch-list-screenshot.png)
...
Example: `http://example.com/static/react/smarter-vectorsearch-list/manifest.json`
