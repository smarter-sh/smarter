/**
 * Main entry point for the Smarter Vectorsearch List React application.
...
const rootEl = document.getElementById("smarter-vectorsearch-list-root");
...
const ApiUrl = rootEl.getAttribute("smarter-vectorsearch-list-api-url");
...
if (!ApiUrl) throw new Error("Vectorsearch list API URL not found in root element attributes");
