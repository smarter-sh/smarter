# Smarter MCPClients List React App

This is the source code for the MCPClients List app located
at [http://localhost:9357/mcpclient/](http://localhost:9357/mcpclient/).

This component is served by Django. See also:

- [smarter.apps.mcpclient.views.listview.view.MCPClientListView](../../smarter/apps/mcpclient/views/listview/view.py)
- [smarter.apps.mcpclient.templatetags.react_mcpclient_list.mcpclient_list_react_assets](../../smarter/apps/mcpclient/templatetags/react_mcpclient_list.py)
- [templates/react/mcpclient-list.html](../../smarter/templates/react/mcpclient-list.html)

## Screen Shot

![MCPClient List Screenshot](https://cdn.smarter.sh/github.com/smarter-sh/react/mcpclient-list-screenshot.png)
...
Example: `http://example.com/static/react/smarter-mcpclient-list/manifest.json`
...
```json
{
  ...
  "_custom": {
    ...
    "config": {
      "cdnDeploy": false,
      "s3BucketPath": "s3://smarter.sh/react/smarter-mcpclient-list/",
