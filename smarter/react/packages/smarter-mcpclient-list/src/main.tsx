/**
 * Main entry point for the Smarter MCPClient List React application.
...
const ApiUrl = rootEl.getAttribute("smarter-mcpclient-list-api-url");
...
if (!ApiUrl) throw new Error("MCPClient list API URL not found in root element attributes");
