/**
 * Main entry point for the Smarter Guardrail List React application.
...
const rootEl = document.getElementById("smarter-guardrail-list-root");
...
const ApiUrl = rootEl.getAttribute("smarter-guardrail-list-api-url");
...
if (!ApiUrl) throw new Error("Guardrail list API URL not found in root element attributes");
