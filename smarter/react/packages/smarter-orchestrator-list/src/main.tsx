/**
 * Main entry point for the Smarter Orchestrator List React application.
...
const rootEl = document.getElementById("smarter-orchestrator-list-root");
...
const ApiUrl = rootEl.getAttribute("smarter-orchestrator-list-api-url");
...
if (!ApiUrl) throw new Error("Orchestrator list API URL not found in root element attributes");
