# Smarter Orchestrators List React App

This is the source code for the Orchestrators List app located
at [http://localhost:9357/orchestrator/](http://localhost:9357/orchestrator/).

This component is served by Django. See also:

- [smarter.apps.orchestrator.views.listview.view.OrchestratorListView](../../smarter/apps/orchestrator/views/listview/view.py)
- [smarter.apps.orchestrator.templatetags.react_orchestrator_list.orchestrator_list_react_assets](../../smarter/apps/orchestrator/templatetags/react_orchestrator_list.py)
- [templates/react/orchestrator-list.html](../../smarter/templates/react/orchestrator-list.html)

## Screen Shot

![Orchestrator List Screenshot](https://cdn.smarter.sh/github.com/smarter-sh/react/orchestrator-list-screenshot.png)
...
Example: `http://example.com/static/react/smarter-orchestrator-list/manifest.json`
...
```json
{
  ...
  "_custom": {
    ...
    "config": {
      "cdnDeploy": false,
      "s3BucketPath": "s3://smarter.sh/react/smarter-orchestrator-list/",
