# Smarter LLMHosts List React App

This is the source code for the LLMHosts List app located
at [http://localhost:9357/llmhost/](http://localhost:9357/llmhost/).

This component is served by Django. See also:

- [smarter.apps.llmhost.views.listview.view.LLMHostListView](../../smarter/apps/llmhost/views/listview/view.py)
- [smarter.apps.llmhost.templatetags.react_llmhost_list.llmhost_list_react_assets](../../smarter/apps/llmhost/templatetags/react_llmhost_list.py)
- [templates/react/llmhost-list.html](../../smarter/templates/react/llmhost-list.html)

## Screen Shot

![LLMHost List Screenshot](https://cdn.smarter.sh/github.com/smarter-sh/react/llmhost-list-screenshot.png)
...
Example: `http://example.com/static/react/smarter-llmhost-list/manifest.json`
...
```json
{
  ...
  "_custom": {
    ...
    "config": {
      "cdnDeploy": false,
      "s3BucketPath": "s3://smarter.sh/react/smarter-llmhost-list/",
