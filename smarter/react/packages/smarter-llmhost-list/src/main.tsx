/**
 * Main entry point for the Smarter LLMHost List React application.
...
const rootEl = document.getElementById("smarter-llmhost-list-root");
...
const ApiUrl = rootEl.getAttribute("smarter-llmhost-list-api-url");
