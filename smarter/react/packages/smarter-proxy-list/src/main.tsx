/**
 * Main entry point for the Smarter Proxy List React application.
...
const rootEl = document.getElementById("smarter-proxy-list-root");
...
const ApiUrl = rootEl.getAttribute("smarter-proxy-list-api-url");
...
if (!ApiUrl) throw new Error("Proxy list API URL not found in root element attributes");
