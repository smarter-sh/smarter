"""Django Config for the Vectorsearch app."""
...
class VectorsearchConfig(AppConfig, SmarterHelperMixin):
    """Django Config for the Vectorsearch app."""
    ...
    def ready(self):
        ...
        logger.debug("%s app is %s", f"{SMARTER_APP_NAME} {presentation_app_name}", self.formatted_state_ready)
