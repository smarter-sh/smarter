"""Django template tags for the vectorsearch list app."""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/vectorsearch-list", templatetag_name=__name__)
"""
...
static/react/@smarter/vectorsearch-list/.
...
@register.simple_tag
def vectorsearch_list_react_assets() -> AssetDict:
    """
