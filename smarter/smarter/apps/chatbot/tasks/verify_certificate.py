"""
Celery tasks for verifying chatbot ACM certificates.

This module defines Celery tasks for verifying AWS ACM certificates associated with chatbot custom domains, including signal handling and logging.
...
Task execution and certificate verification are logged using the smarter logging library, with waffle switches for task and chatbot logging.

Usage
-----

Import this module and call the Celery task as needed to asynchronously verify a chatbot ACM certificate:
