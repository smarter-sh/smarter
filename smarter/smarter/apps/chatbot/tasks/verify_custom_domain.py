"""
Celery tasks for verifying chatbot custom domains.

This module defines Celery tasks for verifying the NS records of AWS Route53 hosted zones for chatbot custom domains, including periodic re-verification, signal handling, and notification of account owners.
...
Import this module and call the Celery task as needed to asynchronously verify a chatbot custom domain:
...
from .exceptions import ChatBotTaskError
