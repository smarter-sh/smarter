"""
Celery tasks for registering chatbot custom domains.

This module defines Celery tasks for registering custom domains for chatbots, including creating AWS Route53 hosted zones, ACM certificates, and DNS records, as well as associating domains with accounts.
...
Task execution and domain registration are logged using the smarter logging library, with waffle switches for task and chatbot logging.

Usage
-----

Import this module and call the Celery task as needed to asynchronously register a chatbot custom domain:
