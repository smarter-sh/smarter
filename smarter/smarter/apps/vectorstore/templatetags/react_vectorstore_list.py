"""Django template tags for the vectorstore list app."""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/vectorstore-list", templatetag_name=__name__)
"""
...
static/react/@smarter/vectorstore-list/.
...
@register.simple_tag
def vectorstore_list_react_assets() -> AssetDict:
    """
