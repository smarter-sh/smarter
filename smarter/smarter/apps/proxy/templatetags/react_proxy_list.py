"""Django template tags for the proxy list app."""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/proxy-list", templatetag_name=__name__)
"""
...
static/react/@smarter/proxy-list/.
...
@register.simple_tag
def proxy_list_react_assets() -> AssetDict:
    """
