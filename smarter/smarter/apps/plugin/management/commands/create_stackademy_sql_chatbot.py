"""
Command to create a demo chatbot for the Stackademy SQL database connection.
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        file_path = os.path.join(
            ...
            "data",
            "sample-plugins",
            "chatbot-stackademy-sql.yaml",
        )

        # python manage.py apply_manifest --filespec 'smarter/apps/plugin/data/sample-plugins/chatbot-stackademy-sql.yaml' --username admin
        call_command(
            "apply_manifest",
