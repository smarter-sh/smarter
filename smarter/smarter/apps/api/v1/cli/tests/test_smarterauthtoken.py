...
class TestApiCliV1SmarterAuthToken(ApiV1CliTestBase):
    ...
    def test_apply(self) -> None:
        ...
        loader = SAMLoader(file_path="smarter/lib/django/drf/tests/data/auth-token.yaml")
