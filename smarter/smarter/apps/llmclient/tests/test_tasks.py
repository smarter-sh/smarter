    ...
    def test_deploy_default_api(self):
        ...
        while retries > 0 and a_record is None:
            a_record = aws_helper.route53.get_dns_record(  # type: ignore
                hosted_zone_id=hosted_zone_id, record_name=self.llmclient.default_host, record_type="A"
            )
            if a_record is None:
        ...
        resolved_hostname = aws_helper.aws.domain_resolver(self.llmclient.default_host)
