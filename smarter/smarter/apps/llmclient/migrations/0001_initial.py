...
import smarter.apps.llmclient.models.llmclient
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        validators=[smarter.apps.llmclient.models.llmclient.validate_provider],
                    ),
                ),
                (
                    "default_model",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="You are a helpful llmclient. When given the opportunity to utilize function calling, you should always do so. This will allow you to provide the best possible responses to the user. If you are unable to provide a response, you should prompt the user for more information. If you are still unable to provide a response, you should inform the user that you are unable to help them at this time.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    "app_name",
                    models.CharField(blank=True, default="llmclient", max_length=255, null=True),
                ),
                (
                    "app_assistant",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="Welcome to the llmclient!",
                        max_length=255,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="llmclient.llmclientcustomdomain",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="llmclient.llmclientcustomdomaindns",
            ),
        ),
        migrations.CreateModel(
