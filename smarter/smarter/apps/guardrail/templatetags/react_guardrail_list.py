"""Django template tags for the guardrail list app."""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/guardrail-list", templatetag_name=__name__)
"""
...
static/react/@smarter/guardrail-list/.
...
@register.simple_tag
def guardrail_list_react_assets() -> AssetDict:
    """
