...
class OrchestratorListView(SmarterAuthenticatedNeverCachedWebView):
    """
    ...
    template_path = "react/orchestrator-list.html"
    orchestrators: list[Orchestrator]

    @property
    def formatted_class_name(self) -> str:
        """Returns a formatted string of the class name for logging purposes."""
        class_name = f"{__name__}.{OrchestratorListView.__name__}[{id(self)}]"
    ...
    def get(self, request: ASGIRequest, *args, **kwargs):
        ...
        context = {
            "orchestrator_list": {
                "root_id": "smarter-orchestrator-list-root",
                ...
                "orchestrator_list_api_url": reverse(
                    OrchestratorReverseNames.namespace, OrchestratorReverseNames.listview_api_all
                ),
