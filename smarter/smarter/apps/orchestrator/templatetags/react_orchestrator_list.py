"""Django template tags for the orchestrator list app."""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/orchestrator-list", templatetag_name=__name__)
"""
...
static/react/@smarter/orchestrator-list/.
...
@register.simple_tag
def orchestrator_list_react_assets() -> AssetDict:
    """
