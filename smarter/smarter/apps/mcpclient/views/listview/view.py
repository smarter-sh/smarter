...
class MCPClientListView(SmarterAuthenticatedNeverCachedWebView):
    ...
    template_path = "react/mcpclient-list.html"
    ...
    def get(self, request: ASGIRequest, *args, **kwargs):
        ...
        context = {
            "mcpclient_list": {
                "root_id": "smarter-mcpclient-list-root",
                ...
                "mcpclient_list_api_url": reverse(
                    MCPClientReverseNames.namespace, MCPClientReverseNames.listview_api_all
                ),
