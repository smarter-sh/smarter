"""Django template tags for the mcpclient list app."""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/mcpclient-list", templatetag_name=__name__)
"""
...
static/react/@smarter/mcpclient-list/.
...
@register.simple_tag
def mcpclient_list_react_assets() -> AssetDict:
    """
