"""Django template tags for the llmhost list app."""
...
templatetag_manager = SmarterReactTemplateTagManager(app_name="@smarter/llmhost-list", templatetag_name=__name__)
"""
...
static/react/@smarter/llmhost-list/.
...
@register.simple_tag
def llmhost_list_react_assets() -> AssetDict:
    """
