...
class SAMJournal(models.Model):
    ...
    thing = models.CharField(max_length=24, choices=SmarterJournalThings.all_values())
    command = models.CharField(max_length=24, choices=SmarterJournalCliCommands.all_values())
